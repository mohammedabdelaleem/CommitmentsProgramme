    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "CreatedAt", "Discriminator", "DisplayName", "IsDefault", "IsDeleted", "Name", "NormalizedName" },
                values: new object[,]
                {
                    { "01979187-c392-77be-89d1-ffe5c2623fae", "01979187-c392-77be-89d1-ffe6910b4102", new DateTime(2026, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "ApplicationRole", "مدير النظام", false, false, "Admin", "ADMIN" },
                    { "01979187-c392-77be-89d1-ffe7d2df25d4", "01979187-c392-77be-89d1-ffe8850dfea6", new DateTime(2026, 12, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "ApplicationRole", "مستخدم", true, false, "Member", "MEMBER" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Bio", "ConcurrencyStamp", "CreatedAt", "Email", "EmailConfirmed", "FullName", "IsDisabled", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "01979187-c392-77be-89d1-ffe5c2623fae", "01978f6e-267c-7c96-b179-d2e08d73f69b" },
                    { "01979187-c392-77be-89d1-ffe7d2df25d4", "8f6b2a34-0b19-4b27-91d0-ec4f74f1a29c" }
                });
