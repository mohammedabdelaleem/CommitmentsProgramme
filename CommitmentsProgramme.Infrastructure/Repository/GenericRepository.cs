...
public class GenericRepository<T> : IGenericRepository<T> where T : BaseEntity // we need id at save
{
...
Func<IQueryable<T>, IIncludableQueryable<T, object>>? include = null,
	...
	public async Task SaveAsync(T entity, string username, CancellationToken cancellationToken = default)
	{
